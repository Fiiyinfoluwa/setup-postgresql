...
echo "Create New User in PostgreSQL"
echo "Enter Username: "
read User
sudo -u postgres createuser --interactive $User -P
echo "DONE"
echo "----"
echo "  "
...
echo "Enter existing user to connect database with: "
read user 

sudo createdb -U $user $databasename 
echo "DONE"
echo "----"
echo "  "
